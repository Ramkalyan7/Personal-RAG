...
export function ProjectsPage() {
  ...
  return (
    <PageFrame className="flex h-[calc(100vh-var(--app-header-height))] flex-col overflow-hidden py-8 lg:py-10">
      <div className="mx-auto flex min-h-0 w-full max-w-6xl flex-1 flex-col">
        ...
        {isLoading ? (
          ...
          <div
            className="mt-10 flex min-h-0 flex-1 flex-col overflow-hidden rounded-[1.4rem]"
            style={{
              backgroundColor:
